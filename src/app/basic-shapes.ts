...
export class BasicShapesExample {
  ...
  constructor(app: ThreeJSApp) {
    ...
    svgshape.rect({ x: 10, y: 10, width: 30, height: 30, stroke: 'black', fill: 'transparent', strokeWidth: 5 })
    svgshape.rect({ x: 60, y: 10, rx: 10, ry: 10, width: 30, height: 30, stroke: 'black', fill: 'transparent', strokeWidth: 5 })

    svgshape.circle({ cx: 25, cy: 75, r: 20, stroke: 'red', fill: 'transparent', strokeWidth: 5 })
